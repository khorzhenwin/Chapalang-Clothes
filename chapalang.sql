...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2022 at 10:40 AM
...
CREATE TABLE `message` (
  ...
  `MessageReadUser` int(11) NOT NULL DEFAULT 0,
  `MessageReadVendor` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(49, 'Ducky Home Slippers', 'comfy home slippers made from soft cotton', 'slippers, shoes, unisex, men, women, kids, yellow, ducks, feet, foot', 'images/items/duckckck.jpg,images/items/duckslippers.jpg,images/items/ducky.jpg', '60.00', 28, 'Approved', 10),
...
(30, 49, 63, 'heehee', 'Pending', '2022-01-22', 'images/refund/shen3.jpg');
...
INSERT INTO `review` (`ReviewId`, `ProductId`, `UserId`, `ReviewRating`, `ReviewTitle`, `ReviewComment`, `ReviewDate`) VALUES
(2, 32, 2, 5, 'Dank meme bro', '100% quality meme material. Would buy again.', '2022-01-22 03:18:36'),
(3, 9, 2, 4, 'is good instant shoe', 'i just pour water and wait 1 minute ez 10/10', '2022-01-22 03:18:36'),
(4, 16, 2, 5, 'i can be my dream', 'i always want to be yakuza now i can\r\nthankx 10/10', '2022-01-22 03:18:36'),
(5, 30, 2, 3, 'this glasses too yellow', 'this glass make everything yellow not nice :(', '2022-01-22 03:18:36'),
(6, 57, 3, 1, 'bullshit', 'I am beautiful >.<', '2022-01-22 03:18:36'),
(7, 32, 4, 5, 'meme god', 'made me real good mayn got me all the ladies', '2022-01-22 03:18:36'),
(8, 57, 4, 5, 'Cool mask', 'product mantap. quality beb shipping pun cepat xde komplain. boleh repeat', '2022-01-22 03:18:36'),
(9, 54, 2, 2, 'i only get helmet', 'NO MONKEYS THIS IS SCAME!!!', '2022-01-22 03:18:36'),
(10, 23, 5, 5, 'Fuh', 'Fuh really form the future eh, imma living in Cyberpunk 2077', '2022-01-22 03:18:36'),
(11, 16, 5, 5, 'Dame Dane', 'DAME DANE ', '2022-01-22 03:18:36'),
(12, 30, 4, 5, 'Nice glasses', 'good quality, worth for price. would buy again', '2022-01-22 03:18:36'),
(14, 15, 5, 5, 'I don\'t have any oppai :( ', 'But now I do :D ', '2022-01-22 03:18:36'),
(15, 45, 2, 4, 'this shirt make me less fat', 'people will see the shirt and not my fat stomach so i fell less fat. 10/10', '2022-01-22 03:18:36'),
(16, 55, 2, 3, 'i liek fairytail', 'i like faritail so i buy this shirt very nice material.', '2022-01-22 03:18:36'),
(17, 49, 4, 5, 'Comfortable home slippers', 'produk berkualiti. seller baik bungkus cantik. shipping pun cepat', '2022-01-22 03:18:36'),
(18, 57, 5, 2, 'Kinda fake', 'Looks good in picture, doesn\'t look good in real life ', '2022-01-22 03:18:36'),
(19, 39, 5, 5, 'Bought it for my whole family', 'THey LIKED IT', '2022-01-22 03:18:36'),
(20, 52, 4, 5, 'WORKS LIKE IN TITLE', 'i tried scaring my mom wearing this while holding a knife and she ran away giving me her money. ez cash bruh', '2022-01-22 03:18:36'),
(22, 50, 3, 5, 'Weebo', 'Weeb fans here bois!!!', '2022-01-22 03:18:36'),
(23, 57, 2, 5, 'i buy 2', 'one for myself and one for myself. i rate 10/10\r\nape shall not kill ape', '2022-01-22 03:18:36'),
(24, 52, 2, 4, 'i feel safe in this suit', 'best furry suit i buy thanks.', '2022-01-22 03:18:36'),
(25, 15, 2, 5, 'i now can be one punch man', 'i can one punch my oppai', '2022-01-22 03:18:36'),
(26, 18, 2, 5, 'i use this for cosplay', 'i cosplay crypto from apex legends.', '2022-01-22 03:18:36'),
(27, 64, 2, 5, 'i buy this air', 'and i wait 2 weeks and i didnt get covid. this is good quality air 5/5', '2022-01-22 03:18:36'),
(29, 36, 2, 5, 'berts nekclasle', 'I boughy for my neck, he like it', '2022-01-22 03:18:36'),
(30, 63, 2, 5, 'i love naruto', 'i like naruto i use this shirt to naruto run', '2022-01-22 03:18:36'),
(31, 44, 2, 4, 'Good quality material', 'Nice face I wear outside all the time. Shipping is fast. 10/10', '2022-01-22 03:18:36'),
(32, 4, 4, 4, 'It has nice tippy toes', 'yo this mad soft cloth', '2022-01-22 03:18:36'),
(33, 61, 5, 5, 'Wow ', 'Suits me real good ', '2022-01-22 03:18:36'),
(34, 61, 4, 5, 'Great for those kinky nights', 'red in colour like your mother', '2022-01-22 03:18:36'),
(35, 4, 5, 3, 'Kinda plain', 'the pattern is actually quite small, mostly white shirt', '2022-01-22 03:18:36'),
(36, 3, 4, 3, 'Could be better', 'stitching is off\r\npvc leather feels cheap\r\nwouldnt reorder', '2022-01-22 03:18:36'),
(37, 39, 2, 3, 'fake item', 'dont buy is fake item', '2022-01-22 03:18:36'),
(45, 50, 1, 4, 'good product', 'good nice', '2022-01-22 03:18:36'),
(46, 15, 1, 4, 'is not good ', 'yuck', '2022-01-22 03:18:36');
...
(1, 'images/users/f65c2c55f5d7f94bcfc7840855309e9d90b2e874.png', 'test', '9d4e1e23bd5b727046a9e3b4b7db57bd8d6ee684', 'test@test.com', 'Female', '2019-11-01', 'No 1 Jalan Terus,\r\nTaman Permainan,\r\n57700 Seri Pintu\r\nSelangor'),
...
(10, 'FrancFrunkShop', 'francfrunk', '7a1ea28b0173bdb742a05fbaf75e42735fc5b77d', 'francfrunk@mail.com', 'I come from the East, but my sales of clothes rise like yeast', '57 Tenom Coffee, Kopi Susu', '2125.00', 'images/vendors/vendor8.png'),
...
--
ALTER TABLE `refund`
  MODIFY `RefundId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `review`
  MODIFY `ReviewId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
